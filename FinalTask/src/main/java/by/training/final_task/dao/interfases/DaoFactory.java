...
public interface DaoFactory {
    ...
    CouponUserDAO createCouponUserDAO(AbstractConnectionManager
                                              newConnectionManager);

    CouponDAO createCouponDAO(AbstractConnectionManager newConnectionManager);

    CompanyProviderDAO createCompanyProviderDAO(AbstractConnectionManager
                                                        newConnectionManager);

    CategoryDAO createCategoryDAO(AbstractConnectionManager
                                          newConnectionManager);
}
