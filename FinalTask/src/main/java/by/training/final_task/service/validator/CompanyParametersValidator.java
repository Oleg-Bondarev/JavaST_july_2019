...
public class CompanyParametersValidator extends Validator implements Valid {
    ...
    public static final String REGEX_FOR_COMPANY_NAME = "^[a-zA-Zа-яА-Я0-9-\" ]+$";
    public static final String REGEX_FOR_COMPANY_ADDRESS = "^[a-zA-Zа-яА-Я0-9-\",. ]+$";
    public static final String REGEX_FOR_PHONE = "^((25)|(29)|(33)|(44))([0-9]{7}$)";
