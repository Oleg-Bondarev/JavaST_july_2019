...
public class CouponFormParser extends FormParser<Coupon> {
    ...
    public Coupon parse(final Action newAction,
        ...
        if ((newParameters != null) && !newParameters.contains(null)
            ...
            CouponParametersValidator validator = new CouponParametersValidator();
            ...
            String couponName = newParameters.get(validator.getCouponNameIndex());
            String couponDescription = newParameters.get(validator.getCouponDescriptionIndex());
            String stringPrice = newParameters.get(validator.getCouponPriceIndex());
