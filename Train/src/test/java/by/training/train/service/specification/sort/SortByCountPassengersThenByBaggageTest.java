...
public class SortByCountPassengersThenByBaggageTest {

    List<PassengerCarriage> expectList;
    PassengerTrainRepository trainRepository;
    CompartmentCarriage compartmentCarriage1, compartmentCarriage2, compartmentCarriage3;
    ...
    public void setUp() {
        ...
        compartmentCarriage2 =
                new CompartmentCarriage(2, ServiceEnum.ECONOM, 34,
                        50.0, Boolean.valueOf("false"), 9);
        compartmentCarriage3 =
                new CompartmentCarriage(2, ServiceEnum.ECONOM, 34,
                        50.1, Boolean.valueOf("false"), 9);
        economClassCarriage1 =
                new EconomClassCarriage(2, ServiceEnum.ECONOM, 15,
                        20.0, Boolean.valueOf("true"), 9, EconomClassEnum.RESERVEDSEAT);
        economClassCarriage2 =
                new EconomClassCarriage(2, ServiceEnum.ECONOM, 80,
        ...
        trainRepository.addCarriage(Optional.of(compartmentCarriage3));
        ...
        expectList.add(compartmentCarriage3);
        expectList.add(economClassCarriage2);
    }

    @Test(description = "Sorting carriages by baggage.")
    public void testSort() {
        SortByCountPassengersThenByBaggage sorting =
                new SortByCountPassengersThenByBaggage();
        List<PassengerCarriage> actualList =
                sorting.sort(trainRepository.getTrainCarriageList());
