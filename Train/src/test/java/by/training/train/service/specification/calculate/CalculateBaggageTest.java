...
public class CalculateBaggageTest {
    ...
    CalculateBaggage calculateBaggage = new CalculateBaggage();
    ...
    public void setUp() {
        ...
        compartmentCarriage1 =
                new CompartmentCarriage(2, LUX, 30, 11.0, Boolean.valueOf("true"), 9);
        compartmentCarriage2 =
                new CompartmentCarriage(2, LUX, 30, 4.0, Boolean.valueOf("true"), 9);
        economClassCarriage1 =
                new EconomClassCarriage(2,ServiceEnum.ECONOM,22,20.0, Boolean.valueOf("true"), 9, EconomClassEnum.RESERVEDSEAT);
        economClassCarriage2 =
                new EconomClassCarriage(2,ServiceEnum.ECONOM,22,10.0, Boolean.valueOf("true"), 9, EconomClassEnum.COMMON);
        seatingCarriage1 =
    ...
    @Test
    public void testCalculateBaggage() {
        double actual = calculateBaggage.calculateBaggage(Optional.of(trainRepository.getTrainCarriageList()));
        assertEquals(actual, 2040.0, 0.01);
    }
}